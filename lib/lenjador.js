const adaptersFactory = require('./lenjador/adapters');
const preprocessorsFactory = require('./lenjador/preprocessors');
...
class Lenjador {
  static build(serviceName, loggersConfig = {stdout: {}}, preprocessorsConfig = {}) {
    ...
    return new Lenjador(adapters, preprocessors);
  }
